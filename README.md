...
- 🔭 I’m currently working on my master's thesis which is on visual analysis of mobile sensing data to correlate it with mental health. Have a sneak peak of the visual techniques used (Visual analysis of IRIS dataset)[here](https://github.com/mohd-muzamil/IrisDashboard.git) [Demo](https://explorata.herokuapp.com) and (Implementation using Randomly generated mobile sensing dataset since original dataset is private)[here](https://github.com/mohd-muzamil/flaskDashboard.git)
