...
- :chart_with_upwards_trend: I’m recently defended my master's thesis which is on visual analysis of mobile sensing data to correlate it with mental health. 
...
<!--         <td><img alt="Pull Requests" src="https://img.shields.io/github/issues-pr/mohd-muzamil/changeMyPet?style=flat-square"/></td> -->
      ...
      <tr>
        <td><a href="https://github.com/mohd-muzamil/Dashboard:Traffic Incidents(UK)"><b>Dashboard - Traffic incidents(UK)</b></a></td>
